...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit Pemeriksaan Pasien</h1>
    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless">
                            <tr>
                                ...
                                <td width="5%">:</td>
                                <td><strong>{{ $pemeriksaan->pendaftaran->pasien->no_rm }}</strong></td>
                            </tr>
                            <tr>
                                <td>Nama</td>
                                <td>:</td>
                                <td>{{ $pemeriksaan->pendaftaran->pasien->nama_lengkap }}</td>
                            </tr>
                            <tr>
                                <td>Usia</td>
                                <td>:</td>
                                <td>{{ \Carbon\Carbon::parse($pemeriksaan->pendaftaran->pasien->tanggal_lahir)->age }} Tahun</td>
                            </tr>
                            <tr>
                                <td>Jenis Kelamin</td>
                                <td>:</td>
                                <td>{{ $pemeriksaan->pendaftaran->pasien->jenis_kelamin }}</td>
                            </tr>
                        </table>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-sm">
                            <tr>
                                <td>TD</td>
                                <td>: {{ $pemeriksaan->pendaftaran->vitalSign->tekanan_darah }} mmHg</td>
                            </tr>
                            <tr>
                                <td>Suhu</td>
                                <td>: {{ $pemeriksaan->pendaftaran->vitalSign->suhu_tubuh }} °C</td>
                            </tr>
                            <tr>
                                <td>Nadi</td>
                                <td>: {{ $pemeriksaan->pendaftaran->vitalSign->nadi }} x/menit</td>
                            </tr>
                            <tr>
                                <td>RR</td>
                                <td>: {{ $pemeriksaan->pendaftaran->vitalSign->pernapasan }} x/menit</td>
                            </tr>
                            <tr>
                                <td>BB/TB</td>
                                <td>: {{ $pemeriksaan->pendaftaran->vitalSign->berat_badan }} kg / {{ $pemeriksaan->pendaftaran->vitalSign->tinggi_badan }} cm</td>
                            </tr>
                            <tr>
                                <td colspan="2" class="pt-2"><strong>Keluhan Utama:</strong><br>
                                {{ $pemeriksaan->pendaftaran->keluhan }}</td>
                            </tr>
                        </table>
                    </div>
                </div>
            ...
            <form action="{{ route('dokter.pemeriksaan.update', $pemeriksaan->id) }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="diagnosis_utama" class="form-control" value="{{ old('diagnosis_utama', $pemeriksaan->diagnosis_utama) }}" required>
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3" id="tanggal_kontrol_wrapper" style="{{ $pemeriksaan->rencana_tindak_lanjut == 'Kontrol' ? '' : 'display: none;' }}">
                                ...
                                <input type="date" name="tanggal_kontrol" class="form-control" value="{{ $pemeriksaan->tanggal_kontrol }}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div id="obat-container">
                            @if($resep && $resep->details->count() > 0)
                                @foreach($resep->details as $detail)
                                    <div class="row mb-3 obat-item">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="aturan_pakai[]" class="form-control" placeholder="Aturan Pakai" value="{{ $detail->aturan_pakai }}">
                                        </div>
                                        <div class="col-md-1">
                ...
                <div class="d-grid gap-2 mb-4">
                    <button type="submit" class="btn btn-primary btn-lg">
                        <i class="fas fa-save me-2"></i> Update Pemeriksaan & Resep
                    </button>
