...
<head>
    ...
    <title>Login Apoteker - RS PROJEK WEB 6</title>
...
<body>
    <div class="login-card">
        ...
        <h1 class="login-title">Login Apoteker</h1>
        <p class="login-subtitle">Silakan masuk sebagai Apoteker</p>
        ...
        <form method="POST" action="{{ route('login.post') }}">
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control" id="email" name="email" value="{{ old('email') }}" required autofocus placeholder="apoteker@email.com">
            </div>
